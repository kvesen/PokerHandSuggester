          ...
          children: [
            ...
            _StatsRow(
              items: [
                _StatItem(
                  label: 'Equity',
                  value: decision.equityPercent,
                  icon: Icons.bar_chart,
                  color: const Color(0xFF1565C0),
                ),
                _StatItem(
                  label: 'Pot Odds',
                  value: decision.potOddsPercent,
                  icon: Icons.percent,
                  color: const Color(0xFF6A1B9A),
                ),
                _StatItem(
                  label: 'EV',
                  value: decision.evFormatted,
                  icon: Icons.trending_up,
                  color: decision.expectedValue >= 0
            ...
            _EquityBreakdown(result: equityResult),
            const SizedBox(height: 20),
            ...
            if (gameState.communityCards.isNotEmpty) ...[
              ...
              Wrap(
                ...
                children: gameState.communityCards
                    .map((c) => CardWidget(card: c, size: CardSize.large))
                    .toList(),
              ),
            ],
            const SizedBox(height: 20),
            ...
            // Game info summary
            // ----------------------------------------------------------------
            _GameInfoSummary(gameState: gameState),
